...
if(isset($_POST["submit"])) {
    if(createTransaksi() > 0) {
        ...
        echo "<script>
            ...
            document.location.href = '" . BASE_URL . "/kasir/cetak?id=$transactionId&uang_bayar=$uangBayar';
        </script>";
    }else {
        echo "<script>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= BASE_URL ?>/kasir/detail?id=<?= $transaction["id"] ?>" class="btn btn-info">Lihat</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
