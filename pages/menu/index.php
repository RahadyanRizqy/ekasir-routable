                        ...
                        <?php foreach($menus as $menu) : ?>
                            <?php if(!$menu["deleted_at"]) :?>
                                <tr>
                                    ...
                                    <td><?= $menu["stok"] ?></td>
                                    <td class="d-inline">
                                        <a href="<?= BASE_URL ?>/menu/edit?id=<?= $menu["id"] ?>" class="btn btn-warning mr-3">Edit</a>
                                        <a href="menu/delete?id=<?= $menu["id"] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus data ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        <?php endforeach; ?>
